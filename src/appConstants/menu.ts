...
const MENU_ITEMS: MenuItemType[] = [
    {
        ...
        url: '/home',
        minVersion: 3,
        roleAccess: [ Role.ADMIN, Role.MANAGER, Role.STAFF ]
    },
    {
        key: 'kitchen',
        label: t('Kitchen'),
    ...
    },
    {
        ...
        url: '/products',
        minVersion: 3,
        menuBadgeType: MenuProductBadge,
        roleAccess: [ Role.ADMIN, Role.MANAGER, Role.STAFF ]
    },
    {
        key: 'connectivity',
        ...
        url: '/connectivity',
        minVersion: 3,
        menuBadgeType: MenuConnectivityBadge,
        roleAccess: [ Role.ADMIN, Role.MANAGER, Role.STAFF ]
    },
    {
        key: 'orders',
    ...
    },
    {
        ...
        children: [
            ...
            {
                key: 'ds-operational-metrics',
                label: t('Operational metrics'),
                url: '/dashboard/operational-metrics',
                parentKey: 'dashboards',
                minVersion: 4,
            },
            {
                key: 'ds-metrics-history',
                label: t('Metrics History'),
                url: '/dashboard/operational-metrics/history',
                parentKey: 'dashboards',
                minVersion: 4
            }
        ],
